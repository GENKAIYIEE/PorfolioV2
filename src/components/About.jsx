        ...
        {isModalOpen && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setIsModalOpen(false)}
                className="absolute top-4 right-4 text-text-secondary hover:text-text-primary transition-colors p-2 z-10 bg-glass-bg hover:bg-glass-border rounded-full"
              >
                <HiX className="w-5 h-5" />
              </button>

              <div className="relative z-10">
                <h3 className="text-2xl md:text-3xl font-bold text-text-primary mb-4" style={{ fontFamily: 'Clash Display, sans-serif' }}>
