        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm text-white/40">
              ...
              <HiHeart className="inline w-3.5 h-3.5 text-red-400 mx-0.5" /> and lots of coffee.
            </p>
          </div>
          ...
          <div className="flex gap-3">
            {[
              ...
              <motion.a
                ...
                className="w-9 h-9 rounded-lg glass flex items-center justify-center text-white/40 hover:text-white transition-colors"
